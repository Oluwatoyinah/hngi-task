        ...
        <div className="w-11/12 md:w-4/5 mx-auto">
          ...
          <div className="head text-center">
            <img
              src={ProfileImg}
              id="profile__img"
              className="rounded-full mx-auto w-[80px] mb-1"
              alt="Profile img"
            />
            <p className="profile-text" id="twitter">
              o_luwatoyin
            </p>
            <p className="profile-text hidden" id="slack">
              Oluwatoyinah
            </p>
          </div>
          <div className="body mt-10">
            <ul>
              <li className="mb-6">
                <a
                  href="https://twitter.com/o_luwatoyin"
                  id="btn__twitter"
                  className="links"
                >
              ...
              <li className="mb-6">
                <a
                  ...
                  id="btn__zuri"
                  title="Where to find books about design and coding"
                  className="links"
                >
              ...
              <li className="mb-6">
                <a
                  href="https://books.zuri.team/python-for-beginners?ref_id=Oluwatoyinah"
                  id="book__python"
                  className="links"
                >
